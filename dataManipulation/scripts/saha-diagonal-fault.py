...
def differentialFaultAttack(c, keyset):
...
differentialFaultAttack(cipher, keysetCipher)

# test second ciphertext to obtain reduced keyset
differentialFaultAttack(cipher1, keysetCipher1)

# test third ciphertext to obtain reduced keyset
differentialFaultAttack(cipher2, keysetCipher2)

# test fourth ciphertext to obtain reduced keyset
differentialFaultAttack(cipher3, keysetCipher3)

# test fourth ciphertext to obtain reduced keyset
differentialFaultAttack(cipher4, keysetCipher4)
